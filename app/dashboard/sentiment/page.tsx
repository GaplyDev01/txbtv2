      ...
      <div className="max-w-7xl mx-auto py-12">
        ...
        <div className="bg-[#1C2620]/40 backdrop-blur-md border border-[#36C58C] rounded-xl p-8">
          <p className="text-gray-400">
            Advanced market sentiment analysis and predictive modeling interface coming soon. This is where we use the X api and have our social feeds, groups, boards.
          </p>
        </div>
      </div>
    </div>
